...
* **Multigigawatt Two-Phase Cryogenic FEA** — dynamic liquid-to-gas Helium-4 nucleate boiling heat rejection ($P_{\text{transient}} \ge 1.4208\text{ GW}$) on a CVD Diamond-on-GaN substrate ($K_\diamond \ge 2000\text{ W}/(\text{m}\cdot\text{K})$) with NbN/MgB₂ superconducting routing (11.79 K quench headroom) and sapphire/aerogel quarter-wave acoustic tamping (35.40 dB shock attenuation).
